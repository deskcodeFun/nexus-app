<template>
  <teleport to="body">
    <div v-show="modalActive" @click.self="emit('close-modal')"
      ...
      <div v-if="modalActive" class="bg-white self-start mt-36 mx-4 w-full sm:w-96">
        ...
        <div class="flex justify-between">
          <button class="text-blue-900 border border-blue-900 mt-8 mx-1 mb-1 rounded-full py-1 px-4 hover:scale-102"
            @click="emit('close-modal')">
            Cancel
          </button>
          <button class="text-white mt-8 mx-1 mb-1 rounded-full bg-red-900 py-1 px-8 hover:scale-102"
