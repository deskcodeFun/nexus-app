<template>
  <BaseHeader title="ADD NEW service" :isShow="true" />
  <label for="date" class="text-gray-600 text-md pr-4">Appointment :</label>
  <input id="date" type="date" v-model="dateAppoint" />
  ...
  <p class="text-gray-600 text-md align-text-bottom my-2">
    Departmant :
    <input type="text" value="department" v-model="department" class="mx-12 px-2 text-lg border" />
  </p>
  <p class="text-gray-600 text-md align-text-bottom my-2">
    Email :
    <input type="email" value="userEmail" v-model="useremail" class="mx-21 px-2 text-lg border" />
  </p>
  <p class="text-gray-600 text-md align-text-bottom my-2">
    Asset Tag :
    <input
      ...
      value="computerTag"
      v-model="computerTag"
      class="mx-15 px-2 text-lg border"
    />
  </p>
...
const checkList = ref([])
const mapDrive = ref([])
console.log('dateAppoint ', dateAppoint.value)
</script>
